    ...
    public boolean addCustomer(String branchName, String customerName, double amount) {
        ...
        if (selectedBranch != null) {
           if (selectedBranch.findCustomer(customerName) == null ) {
               selectedBranch.addCustomer(customerName, amount);
               System.out.println("Customer: " + customerName + " registered successfully  Amount: " + amount);
               return true;
           } else {
    ...
    public boolean addTransaction(String branchName, String customerName, double amount) {
        ...
        if (selectedBranch != null) {
            ...
            if (selectedCustomer != null) {
                ...
                System.out.println(amount + " That's OK :) ");
                return true;
            } else {
